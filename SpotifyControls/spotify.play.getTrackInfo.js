[{ 
	...
	progress: document.getElementById('app-player').contentWindow.document.querySelector('#bar-inner').offsetWidth / document.getElementById('app-player').contentWindow.document.querySelector('#bar-outer').offsetWidth,
